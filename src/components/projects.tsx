  ...
  const projectsData = [
    {
      ...
      techStack: ["JavaScript", "MongoDB Atlas", "Redis", "Express", "React", "Node.js", "Docker", "GitHub Actions", "GCP Cloud Run", "JWT"],
    ...
    },
    {
      ...
      techStack: ["JavaScript", "MongoDB", "Express", "React", "Node.js", "JWT", "Tailwind CSS", "Framer Motion"],
